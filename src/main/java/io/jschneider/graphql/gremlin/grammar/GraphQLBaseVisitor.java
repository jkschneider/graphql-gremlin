...
public class GraphQLBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements GraphQLVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitFieldRelation(@NotNull GraphQLParser.FieldRelationContext ctx) { return visitChildren(ctx); }
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitFieldValue(@NotNull GraphQLParser.FieldValueContext ctx) { return visitChildren(ctx); }
